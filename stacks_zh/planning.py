...
def _collect_repository_state(
    ...
    for path in sorted((root / "translation-data/reviewed").rglob("*.json")):
        ...
        revisions[unit_id] = (str(stage), str(publication_status))
...
def _resolve_action(
    ...
    published_count = sum(
        revisions[unit_id] == ("PUBLISHED", "RELEASED")
    ...
    if candidate_count == 0:
        ...
        risk_by_unit[unit_id] == "R3" and revisions[unit_id][0] == "LANGUAGE_REVIEWED"
