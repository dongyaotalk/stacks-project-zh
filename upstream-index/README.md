...
manifest 必须符合 `schema/upstream-index-manifest.schema.json`，并由
`make upstream-index-check` 与 `upstream.lock`、实际 harvest、`sync-reports/` 和
`UPSTREAM_HISTORY.md` 交叉验证。
