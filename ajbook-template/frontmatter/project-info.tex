...
\begin{description}
  ...
  \item[翻译目录] \nolinkurl{ajbook-template/translations/\TranslationModel}
...
\medskip\noindent
本书以 AJbook 中文数学书模板为排版基础。AJbook 衍生自 Wen-Wei Li（李文威）的
AlJabr-1，并按 CC BY 4.0 许可使用和修改；本书不代表 AJbook 原作者或英文
Stacks Project 对本中文翻译的认可。
